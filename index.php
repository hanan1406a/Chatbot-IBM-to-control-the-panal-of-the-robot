...
<body align="right">
    ...
    <form id="myForm" action="2x.php" method="post" target="dummyframe">
    ...
    <form action="index.php" method="post">
        <div class="main2">
            ...
            <div class="forward">
                <input type="submit" value="Forward" name="action" style="font-size: 30px; background: rgb(86, 140, 158); border-radius: 50px;">
            </div>
            ...
            <div class="center">
                ...
                <input type="submit" value="Right" name="action" style="font-size: 25px; background: rgb(86, 140, 158); border-radius: 50px;">
            </div>

            <div class="backward">
                <input type="submit" value="Backward" name="action" style="font-size: 30px; background: rgb(86, 140, 158) ;border-radius: 50px;">
            </div>
        </div>
    </form>
    ...
    <script src="2x.js"></script>
    
<script  >
  window.watsonAssistantChatOptions = {
      integrationID: "0db39738-2d32-4663-ba98-ff393b6d40b2", // The ID of this integration.
      region: "eu-gb", // The region your integration is hosted in.
      serviceInstanceID: "59c70c2e-b9dc-4109-9591-e33230f375bc", // The ID of your service instance.
